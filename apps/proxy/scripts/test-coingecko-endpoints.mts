// E2E smoke for the five new CoinGecko-backed first-party endpoints.
// Pays each from the Claude-owned Base buyer and prints the settle
// tx + a slice of the upstream response so the operator can eyeball
// the data shape end-to-end.
//
// Total cost: 0.005 + 0.02 + 0.01 + 0.01 + 0.005 = $0.05 USDC.
//
// Env:
...
const ENDPOINTS: Endpoint[] = [
  {
    slug: "suverse-crypto-price-batch",
    priceUsdc: "0.005",
    body: { ids: ["bitcoin", "ethereum", "solana"] },
  },
  {
    slug: "suverse-crypto-ohlc-history",
    priceUsdc: "0.02",
    body: { coin_id: "bitcoin", days: 7 },
  },
  {
    slug: "suverse-crypto-market-rankings",
    priceUsdc: "0.01",
    body: { limit: 20 },
  },
  {
    slug: "suverse-crypto-24h-movers",
    priceUsdc: "0.01",
    body: {},
  },
  {
    slug: "suverse-crypto-trending",
    priceUsdc: "0.005",
    body: {},
  },
];
